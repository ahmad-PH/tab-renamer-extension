Use the command `git diff --merge-base origin/main` to get the diff that this branch is producing w.r.t main, and produce a well-rounded PR description for the branch.
